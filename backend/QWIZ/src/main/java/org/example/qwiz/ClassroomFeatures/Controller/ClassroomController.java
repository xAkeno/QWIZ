...
public class ClassroomController {
    ...
    public ResponseEntity<String> Joinclassroom(@RequestHeader("Authorization") String authorizationHeader,
    ...
    public ResponseEntity<List<ClassroomJoinedDTO>> GetAllClass(
    ...
    public ResponseEntity<List<Classroom>> getAllCreatedClass(
            @RequestHeader("Authorization") String authorizationHeader) {
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            String token = authorizationHeader.substring(7);
